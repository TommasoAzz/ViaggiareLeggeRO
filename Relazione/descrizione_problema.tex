...
Gli studenti fuori sede sono il suo principale target: l'obiettivo è pianificare tanti viaggi quanti ne richiedono, scegliendo le corse e le compagnie, 
rientrando nel budget da loro espresso e al tempo stesso minimizzando la durata complessiva del tempo trascorso in viaggio.\\
...
\begin{itemize}
    ...
    \item il massimo numero di tratte per ogni compagnia, comprensivo di tratte di andata e di ritorno.
\end{itemize}
